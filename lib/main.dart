...
import 'package:push_noti_app/databasehelper.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _queryAll() async {
    final allRows = await dbHelper.queryAllRows(nameController.text);
    cars.clear();
  ...
  //   final allRows = await dbHelper.queryRows(nameController.text);
  //   carsByName.clear();
